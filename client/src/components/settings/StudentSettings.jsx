...
function StudentSettings() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-green-700 to-emerald-500 rounded-2xl text-white p-8">
        ...
        <p className="mt-2 text-green-100">
          Customize your account, academic preferences and notifications.
        </p>
      ...
      >
        ...
        <SettingToggle
          title="Study Resource Notifications"
          checked={settings.resourceNotifications}
          onChange={() => handleToggle("resourceNotifications")}
        />
      ...
      <div className="flex justify-end">
        ...
        <button
          onClick={handleSave}
          className="bg-green-700 hover:bg-green-800 text-white px-8 py-3 rounded-lg flex items-center gap-2 transition"
        >
          <FaFloppyDisk />
          Save Changes
        </button>
